...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { address: @price.address, avg_rating: @price.avg_rating, image: @price.image, latitude: @price.latitude, longitude: @price.longitude, price: @price.price }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { address: @price.address, avg_rating: @price.avg_rating, image: @price.image, latitude: @price.latitude, longitude: @price.longitude, price: @price.price }
    assert_redirected_to price_path(assigns(:price))
  end
